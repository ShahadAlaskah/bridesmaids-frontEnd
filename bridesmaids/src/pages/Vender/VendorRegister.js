...
import { Box, Image,Alert,AlertIcon,AlertTitle,AlertDescription ,FormControl, Text,FormLabel,Input, HStack, Button, VStack, Heading } from '@chakra-ui/react';
...
const VendorRegister = () => {
  ...
  return (
    <Box boxShadow={"lg"} maxW='120%' pb={'2rem'} >
      <HStack ml={'15rem'}>
      <Text className='text-center' fontSize={'1.5rem'} ml={'20rem'}>تسجيل كمزود خدمه</Text>
      <Image src="./img/icon.png" width={"4rem"}/>
      </HStack>
      <FormControl marginTop={'2rem'} marginLeft={'4rem'}>
        ...
        <VStack>
         <Button onClick={formSubmit} backgroundColor={'#CAA892'} textColor={'white'} textAlign={'right'} marginRight={'7rem'} width={'10rem'}>تسجيل</Button>
